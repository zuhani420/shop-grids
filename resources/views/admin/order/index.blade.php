                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.order-delete', ['id' => $order->id])}}" class="btn btn-danger btn-sm {{$order->order_status == 'Complete' || $order->order_status == 'Pending' || $order->order_status == 'Processing' ? 'disabled' : ''}}" title="Order Delete">
